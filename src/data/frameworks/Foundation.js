export const Foundation5 = {
  ...
  'description': 'The most advanced, responsive front-end framework in the world. The framework is mobile friendly and ready for you to customize it any way you want to use it',
  'url': 'http://foundation.zurb.com/sites/docs/v/5.5.3/',
  'documentation': 'http://foundation.zurb.com/sites/docs/v/5.5.3/',
